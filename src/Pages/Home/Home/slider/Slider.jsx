  ...
  return (
    <div>
      <AwesomeSlider infinite={true}>
        <div>
            <img className="w-screen h-min" src="https://images.unsplash.com/photo-1533106958148-daaeab8b83fe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80" alt="" />
        </div>
        <div>
